...
contract PolPick is Ownable {
    ...
    constructor(address _newGameController15, address _newGameController30)
        Ownable(_newGameController15)
    {
    ...
    modifier onlyGameController() {
        require(
            msg.sender == gameController15 || msg.sender == gameController30,
    ...
    // Public function to call the private sendEther function
    ...
    // Methods
    function changeGameControllerAddress15(address newGameControllerAddress)
        public
        onlyOwner
    {
    ...
    function changeGameControllerAddress30(address newGameControllerAddress)
        public
        onlyOwner
    {
